    ...
    <div className="flex flex-col">
      ...
      <section className="relative min-h-[92vh] flex items-center justify-center pt-24 pb-32 px-6 overflow-hidden">
        <div className="container mx-auto text-center z-10 relative">
          ...
          >
            DiamondDigital builds custom software, web platforms, and digital products that are sharp by design, scalable by architecture, and exceptional by default. No templates. No shortcuts.
          </motion.p>
