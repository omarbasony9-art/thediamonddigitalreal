...
const reviews = [
  {
    ...
    rating: 5,
    text: "Diamond Digital delivered our SaaS dashboard six days ahead of schedule. The code quality was unlike anything we'd seen from a previous agency — clean, documented, and actually scalable. We've since expanded the engagement twice.",
  ...
  },
  {
    ...
    rating: 5,
    text: "Trust is everything in finance. Diamond Digital understood that without us having to explain it twice. The site they built projects exactly the credibility we needed. Lead quality from the site improved immediately.",
    service: "Business Website",
    avatar: "CR",
  },
  {
