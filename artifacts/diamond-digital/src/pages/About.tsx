    ...
    <div className="pt-24 pb-32 px-6">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-16 md:mb-32">
          ...
          >
            <p className="text-xs font-mono text-primary tracking-widest mb-4 uppercase">About The Diamond Digital</p>
            ...
            <p className="text-muted-foreground leading-relaxed">
              The Diamond Digital was built by engineers who got tired of watching technically sound projects get buried under poor architecture decisions, vague requirements, and teams that hand off instead of own. We operate with a different model — small, senior, accountable.
            </p>
          </motion.div>
